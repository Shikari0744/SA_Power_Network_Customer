...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:ITAzureChargeBack.completionEmail:1.2.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: TextBody
        args: = "Hi IT Asset Management,"&vbNewLine&vbNewLine&"All projects have been
          journalled and Project Manager's notified."&vbNewLine&"Thanks,"&vbNewLine&"IT
          Automation Team"
    - step:
        id: '6'
