...
operation:
  name: Send_Email_Failure_Regional
  sequential_action:
    gav: com.microfocus.seq:FieldServicesAvailabilityRoster.Send_Email_Failure_Regional:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: Subject
        args: = "Weekly Availability Rosters (Regional) - Roster Update Failed"
    - step:
        id: '5'
        object_path: MyEmail
        action: TextBody
        args: = "Hello,"&vbNewLine&vbNewLine&"The Weekly Availability Roster updates
          for Regional has failed."&vbNewLine&vbNewLine&"Thanks,"&vbNewLine&"IT Automation
          Team"
    - step:
        id: '6'
