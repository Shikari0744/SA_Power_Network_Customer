...
operation:
  ...
  - RunDate:
      required: false
  sequential_action:
    gav: com.microfocus.seq:BCRM_Reports.Send_Email_Unavailable:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: Subject
        args: = "MDP Settlement Reports ("&runDate&") - Reports Not Available (Initiation)"
    - step:
        id: '9'
        object_path: MyEmail
        action: TextBody
        args: = "Hi Team,"&vbNewLine&vbNewLine&"MDP settlement reports for "&runDate&"
          ...
          contact the IT Automation Team to rerun the initiation if you have not heard
          from them."&vbNewLine&vbNewLine&"Thanks,"&vbNewLine&"IT Automation Team."
    - step:
        id: '10'
