...
operation:
  ...
  inputs:
    - RunDate:
        required: false
  sequential_action:
    gav: 'com.microfocus.seq:BCRM_Reports.Send_Email:1.0.0'
    skills:
      - SAP
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          ...
          object_path: MyEmail
          action: Subject
          args: '= "MDP Settlement Reports ("&runDate&") - Automation Completed Successfully"'
      - step:
          id: '9'
          object_path: MyEmail
          action: TextBody
          args: "= \"Hi Team,\"&vbNewLine&vbNewLine&\"MDP settlement reports for \"&runDate&\" have successfully completed.\"&vbNewLine&vbNewLine&\"Please find them available in the nominated Team's folder.\"&vbNewLine&vbNewLine&\"Thanks,\"&vbNewLine&\"IT Automation Team.\""
      - step:
          id: '10'
