...
operation:
  name: Send_Email_Unavailable_1
  inputs:
  - RunDate:
      required: false
  sequential_action:
    gav: com.microfocus.seq:BCRM_Reports.Send_Email_Unavailable_1:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: Subject
        args: = "MDP Settlement Reports ("&runDate&") - Reports Not Available (Downloading)"
    - step:
        id: '9'
        object_path: MyEmail
        action: TextBody
        args: = "Hi Team,"&vbNewLine&vbNewLine&"MDP settlement reports for "&runDate&"
          have stopped due to reports not being available in MSATS."&vbNewLine&vbNewLine&"Please
          contact the IT Automation Team to discuss how to continue (e.g. rerun the
          process, contact MSATS, etc.)."&vbNewLine&vbNewLine&"Thanks,"&vbNewLine&"IT
          Automation Team."
    - step:
        id: '10'
