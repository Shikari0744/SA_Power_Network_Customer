...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:RiverMurrayFloodDisconnections.CID_SiteStatusNULL:1.0.0
    skills:
    - SAP
    - SAPWebExt
    - Web
    ...
    - step:
        ...
        object_path: 'If objSheet.cells(row,10).value = "" and objSheet.cells(row,9).value
          = "" Then '
        comment: 9 = "" means this is a duplicate
    - step:
        id: '31'
        action: Script
...
object_repository:
  ...
  - object:
      ...
      visual_relations: ''
      last_update_time: Wednesday, 4 January 2023 3:32:41 PM
      child_objects:
      - object:
          class: Page
          name: MDM Team Site - Retailer
