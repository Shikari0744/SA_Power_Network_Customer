...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:RiverMurrayFloodDisconnections.C4CNotes:1.0.0
    skills:
    - SAP
    - SAPWebExt
    - Web
    ...
    - step:
        id: '3'
        action: Script
        object_path: c4csheet = Replace(Parameter("floodManagementSheet"), ".xlsx",
          " C4C Notes.csv")
    - step:
        id: '4'
        action: Script
    ...
    - step:
        id: '22'
        action: Script
        object_path: If objSheet.cells(x,3).value = Parameter("sourceofDEEN") and
          objSheet.cells(x,35).value = "Ready to upload" and objSheet.cells(x,29).value
          <> "Yes" and objSheet.cells(x,27).value <> "Bill reversal required" and
          objSheet.cells(x,9).value <> "" Then
    - step:
        id: '23'
        action: Script
    ...
    - step:
        ...
        object_path: objSheetC4C
        action: cells(y,3)
        args: '= "Murray River Flood Management - Disconnection Date: "&processedDate&".
          For reconnection SA Power Networks may require a retailer requested reconnection
          service order. If there has been water damage of any kind, SA Power Networks
          will also require an eCoC on site, after electrical repairs are performed."'
    - step:
        id: '28'
        action: Script
