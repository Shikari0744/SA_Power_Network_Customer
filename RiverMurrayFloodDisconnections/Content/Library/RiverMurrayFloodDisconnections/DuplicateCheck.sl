...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:RiverMurrayFloodDisconnections.DuplicateCheck:1.0.0
    skills:
    - SAP
    - SAPWebExt
    - Web
    ...
    - step:
        id: '32'
        action: Script
        object_path: secondNMI = objSheet.cells(y,1).value
    - step:
        id: '33'
        action: Script
        object_path: If nmi = secondNMI and y <> row Then
    - step:
        id: '34'
        action: Script
        object_path: If objSheet.cells(y,3).value = Parameter("sourceOfDeen")  Then
    - step:
        id: '35'
        action: Script
        object_path: '''if second found NMI is processed, close first NMI'
    - step:
        id: '36'
        action: Script
        object_path: If objSheet.cells(y,2).value = "Processed" Then
    - step:
        id: '37'
    ...
    - step:
        ...
        action: value
        args: = "DUPLICATE ENTRY"
    - step:
        id: '39'
        object_path: objSheet.cells(row,10).value = objSheet.cells(y,10)
        action: value
    - step:
        id: '40'
        object_path: objSheet.cells(row,11).value = objSheet.cells(y,11)
        action: value
    - step:
        id: '41'
        object_path: objSheet.cells(row,12).value = objSheet.cells(y,12)
        action: value
    - step:
        id: '42'
        object_path: objSheet.cells(row,13).value = objSheet.cells(y,13)
        action: value
    - step:
        id: '43'
        action: Script
        object_path: comment = objSheet.cells(row,33).value
    - step:
        id: '44'
        object_path: objSheet.cells(row,33)
        action: value
        args: = "Duplicate entry. "&comment
    - step:
        id: '45'
        action: Script
    ...
    - step:
        id: '46'
        action: Script
        object_path: '''else if both are not processed, extract CID'
    - step:
        id: '47'
        action: Script
        object_path: Else
    ...
    - step:
        id: '58'
        object_path: objSheet.cells(y,2)
        action: value
        args: = "Processed"
    - step:
        id: '59'
    ...
    - step:
        id: '60'
        object_path: objSheet.cells(y,9)
        action: value
        args: = "INSTALLATION NOT FOUND"
    - step:
        id: '61'
    ...
    - step:
        id: '102'
        action: Script
        object_path: '''if first deen date is newer than second deen date'
    - step:
        id: '103'
        action: Script
        object_path: If objSheet.cells(row,4).value > objSheet.cells(y,4).value Then
    - step:
        id: '104'
        object_path: objSheet.cells(row,2)
        action: value
    ...
    - step:
        id: '113'
        action: Script
        object_path: '''else if second deen date is newer than first deen date'
    - step:
        id: '114'
        action: Script
        object_path: Else
    ...
    - step:
        id: '117'
        object_path: objSheet.cells(y,10)
        action: value
        args: = siteAddress
    - step:
        id: '118'
        object_path: objSheet.cells(y,11)
        action: value
        args: = feeder
    - step:
        id: '119'
        object_path: objSheet.cells(y,12)
        action: value
        args: = transformer
    - step:
        id: '120'
        object_path: objSheet.cells(y,13)
        action: value
        args: = meters
    - step:
        id: '121'
        action: Script
        object_path: comment = objSheet.cells(y,33).value
    - step:
        id: '122'
        object_path: objSheet.cells(y,33)
        action: value
        args: = "Duplicate entry. "&comment
    - step:
        id: '123'
...
object_repository:
  ...
  - object:
      ...
      visual_relations: ''
      last_update_time: Monday, 9 January 2023 3:20:58 PM
      child_objects:
      - object:
          class: Page
          name: MDM Team Site - Flood
