...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:NCRDataHandling.CompletionEmail:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: TextBody
        args: = "Hi Chris,"&vbNewLine&vbNewLine&"The NCR Data RPA process has completed
          successfully."&vbNewLine&vbNewLine&"All NCR's added to SAP and list updated."&vbNewLine&vbNewLine&"Thanks,"&vbNewLine&"IT
          Automation Team"
    - step:
        id: '6'
