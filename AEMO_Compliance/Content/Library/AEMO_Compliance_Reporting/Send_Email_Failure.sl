...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:AEMO_Compliance_Reporting.Send_Email_Failure:1.0.0
    skills:
    - Java
    - SAP NWBC Desktop
    - SAP
    ...
    - step:
        ...
        object_path: MyEmail
        action: Subject
        args: = "AEMO Compliance Reporting - Automation Failure"
    - step:
        id: '5'
        object_path: MyEmail
        action: TextBody
        args: = "AEMO Compliance Reporting automation has failed. Please contact automation
