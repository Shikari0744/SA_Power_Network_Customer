...
operation:
  ...
  inputs:
    - RunDate:
        required: false
  sequential_action:
    gav: 'com.microfocus.seq:AEMO_Compliance_Reporting.Send_Email:1.0.0'
    skills:
      - SAP
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          ...
          object_path: MyEmail
          action: Subject
          args: '= "LNSP Settlement Reports ("&runDate&") - Automation Completed Successfully"'
      - step:
          id: '9'
          object_path: MyEmail
          action: TextBody
          args: "= \"Hi Team,\"&vbNewLine&vbNewLine&\"LNSP settlement reports for \"&runDate&\" have successfully completed.\"&vbNewLine&vbNewLine&\"Please find them available in the nominated Team's folder.\"&vbNewLine&vbNewLine&\"Thanks,\"&vbNewLine&\"IT Automation Team.\""
      - step:
          id: '10'
