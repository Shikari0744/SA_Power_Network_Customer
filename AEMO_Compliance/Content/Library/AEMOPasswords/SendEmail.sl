...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:AEMOPasswords.SendEmail:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: Subject
        args: = "AEMO MSATS Passwords Reset"
    - step:
        id: '5'
        object_path: MyEmail
        action: TextBody
        args: = "Hi Team,"&vbNewLine&vbNewLine&"All MSATS account passwords (preproduction
          and production) have been reset to the below password:"&vbNewLine&vbNewLine&Parameter("new_password")&vbNewLine&vbNewLine&"Please
          update the Configuration Items in RPA Central and delete this message."&vbNewLine&vbNewLine&"Thanks"
    - step:
        id: '6'
