...
operation:
  ...
  sequential_action:
    gav: 'com.microfocus.seq:FieldServicesTrendReporting.Send_Email_Failure:1.0.0'
    skills:
      - SAP
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          ...
          object_path: MyEmail
          action: Subject
          args: '= "Field Services Fullness Report (SM-4 Trend) Update - Process Execution Failed"'
      - step:
          id: '5'
          object_path: MyEmail
          action: TextBody
