...
operation:
  name: Send_Email
  sequential_action:
    gav: 'com.microfocus.seq:FieldServicesTrendReporting.Send_Email:1.0.0'
    skills:
      - SAP
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          ...
          object_path: MyEmail
          action: To
          args: '= "DL_SM-4TrendReporting@sapowernetworks.com.au"'
      - step:
          id: '3'
          object_path: MyEmail
          action: From
      ...
      - step:
          ...
          object_path: MyEmail
          action: Subject
          args: '= "Field Services Fullness Reporting (SM-4 Trend) - Successfully updated records in SharePoint."'
      - step:
          id: '5'
          object_path: MyEmail
          action: TextBody
