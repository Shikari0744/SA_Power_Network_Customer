...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:FieldServicesConsolidatedLeaveReporting.HRReport_AnnualLeave:1.0.1
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        id: '287'
        action: Script
        object_path: For e = 10 To current
    - step:
        id: '288'
        action: Script
    ...
    - step:
        id: '297'
        action: Script
        object_path: For e = current To 21
    - step:
        id: '298'
        action: Script
...
object_repository:
  ...
  - object:
      ...
      comments: ''
      visual_relations: ''
      last_update_time: Thursday, 8 September 2022 10:54:59 AM
      child_objects: []
  - object:
      class: SAPGuiSession
      name: Session
