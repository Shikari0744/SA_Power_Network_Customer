...
operation:
  ...
  sequential_action:
    gav: 'com.microfocus.seq:FieldServicesConsolidatedLeaveReporting.HRReport_FlexiandLSL:1.0.1'
    skills:
      - SAP
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          id: '42'
          action: Script
          object_path: 'quota =SAPGuiSession("Session").SAPGuiWindow("Leave Information Report_2").SAPGuiGrid("Employee Leave Quota Informati").GetCellData(i, "Quota Text")'
      - step:
          id: '43'
          action: Script
...
object_repository:
  objects:
    - object:
        ...
        comments: ''
        visual_relations: ''
        last_update_time: 'Monday, 7 February 2022 11:50:22 AM'
        child_objects: []
    - object:
        class: SAPGuiSession
        name: Session
