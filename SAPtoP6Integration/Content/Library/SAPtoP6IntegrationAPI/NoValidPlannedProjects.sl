...
operation:
  name: NoValidPlannedProjects
  inputs:
  - invalidprojectIDs
  sequential_action:
    gav: com.microfocus.seq:SAPtoP6IntegrationAPI.NoValidPlannedProjects:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: Subject
        args: = "SAP to P6 Integration - Planned Extraction Validation Failure"
    - step:
        id: '5'
        object_path: MyEmail
        action: TextBody
        args: = "Hi Team,"&vbNewLine&vbNewLine&"The projects entered for the Planned
          data extraction have all failed the validation check."&vbNewLine&vbNewLine&"The
          following projects are all marked for RUN ACTUALS therefore are not valid
          for Planned extractions:"&Parameter("invalidprojectIDs")&vbNewLine&vbNewLine&"Please
