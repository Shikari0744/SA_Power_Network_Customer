...
operation:
  ...
  sequential_action:
    gav: com.microfocus.seq:OperationsPlanningPBIDatasourcesDaily.FinishedNotification:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: Subject
        args: = "Automation Update - Ops Planning Power BI Datasource Refreshes (Daily)"
    - step:
        id: '5'
        object_path: MyEmail
        action: TextBody
        args: = "Hi Team,"&vbNewLine&vbNewLine&"The updates for all reports have completed
          successfully."&vbNewLine&vbNewLine&"Thanks,"&vbNewLine&"IT Automation Team."
    - step:
        id: '6'
