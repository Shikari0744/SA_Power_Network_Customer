...
operation:
  ...
  - currentReport
  sequential_action:
    gav: com.microfocus.seq:OperationsPlanningPBIDatasourcesDaily.SuccessfulNotification:1.0.0
    skills:
    - SAP
    - Web
    settings:
    ...
    - step:
        ...
        object_path: MyEmail
        action: TextBody
        args: = "Hi Team,"&vbNewLine&vbNewLine&"The updates for "&Parameter("currentReport")&"
          have completed successfully."&vbNewLine&vbNewLine&"Thanks,"&vbNewLine&"IT
          Automation Team."
    - step:
        id: '6'
