...
operation:
  ...
  - location: C:\Users\SVCRPABOT\OneDrive - SA Power Networks\Operations Planning
      PBI Data Sources\
  - wihdata: WIH Data.xlsx
  sequential_action:
    gav: com.microfocus.seq:OperationsPlanningPBIDatasourcesDaily.3_WIHData:1.0.0
    skills:
    - SAP
    - Web
    - WPF
    ...
    - step:
        id: '11'
        action: Script
        object_path: file = Parameter("location")&Parameter("wihdata")
    - step:
        id: '12'
        object_path: SystemUtil
        action: Run
    ...
    - step:
        id: '28'
        action: Script
        object_path: Set sheet = workbook.worksheets("LWP_Detail")
    - step:
        id: '29'
        action: Script
        object_path: Set update = workbook.worksheets("LastDataUpdate")
    - step:
        id: '30'
        action: Wait
        args: '"5"'
    ...
    - step:
        id: '80'
        action: Script
        object_path: '''use current month for the first 14 days of the month, else
          use the next'
    - step:
        id: '81'
        action: Script
        object_path: If Day(Date) < 15 Then
    - step:
        id: '82'
        action: Script
        object_path: fromDate = CStr(Month(Date)) & "." & CStr(Year(Date))
    - step:
        id: '83'
        action: Script
        object_path: If Month(Date) + 11 > 12 Then
    - step:
        id: '84'
        action: Script
        object_path: toDate = CStr((Month(Date) + 11) - 12) & "." & CStr(Year(Date)+
          1)
    - step:
        id: '85'
        action: Script
    ...
    - step:
        id: '86'
        action: Script
        object_path: toDate = CStr(Month(Date) + 11) & "." & CStr(Year(Date))
    - step:
        id: '87'
        action: Script
        object_path: End If
    ...
    - step:
        id: '89'
        action: Script
        object_path: fromDate = CStr(Month(Date) + 1) & "." & CStr(Year(Date))
    - step:
        id: '90'
        action: Script
        object_path: If Month(Date) + 11 => 12 Then
    - step:
        id: '91'
        action: Script
        object_path: toDate = CStr(((Month(Date) + 1) + 11) - 12) & "." & CStr(Year(Date)+
          1)
    - step:
        id: '92'
        action: Script
    ...
    - step:
        id: '93'
        action: Script
        object_path: toDate = CStr((Month(Date) +1) + 11) & "." & CStr(Year(Date))
    - step:
        id: '94'
        action: Script
        object_path: End If
    ...
    - step:
        id: '96'
        object_path: WpfWindow("Prompts").WpfEdit("StartValue_Calendar")
        action: Set
        args: fromDate
    - step:
        id: '97'
        object_path: WpfWindow("Prompts").WpfEdit("EndValue_Calendar")
        action: Set
        args: toDate
    - step:
        id: '98'
    ...
    - step:
        id: '100'
        action: Script
        object_path: "'\tWindow(\"Excel\").WinObject(\"Ribbon\").WinToolbar(\"Quick\
          \ Access Toolbar\").Press \"Save\""
    - step:
        id: '101'
        action: Script
        object_path: "'\tWait 5"
    ...
    - step:
        id: '130'
        action: Script
        object_path: Parameter("reason") = "WIH Data not updated"
    - step:
        id: '131'
        object_path: Reporter
        action: ReportEvent
        args: micFail, "WIH Data not updated" , "WIH Data not updated"
    - step:
        id: '132'
        action: Script
...
object_repository:
  ...
  - object:
      ...
      comments: ''
      visual_relations: ''
      last_update_time: Monday, 30 January 2023 9:29:44 AM
      child_objects:
      - object:
          class: WpfList
