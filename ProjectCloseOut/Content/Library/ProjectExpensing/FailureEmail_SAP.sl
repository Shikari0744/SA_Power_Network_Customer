...
operation:
  name: FailureEmail_SAP
  inputs:
    - User_SAP
  sequential_action:
    gav: 'com.microfocus.seq:ProjectExpensing.FailureEmail_SAP:1.0.0'
    skills:
      - SAP
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          ...
          object_path: MyEmail
          action: Subject
          args: '= "Project Close Out Automation Failure Update"'
      - step:
          id: '3'
          object_path: MyEmail
          action: From
      ...
      - step:
          ...
          object_path: MyEmail
          action: To
          args: '= "Ross.Moutos@sapowernetworks.com.au,Karan.Kumar@sapowernetworks.com.au"'
      - step:
          id: '5'
          object_path: MyEmail
          action: TextBody
          args: '= "Multiple SAP sessions were open for "&Parameter("User_SAP")&". The user nominated to cease process if multiple sessions were found"'
      - step:
          id: '6'
